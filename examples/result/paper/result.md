...
In particular, the $Q^{j}H^{d - 2j}$ lie in distinct eigenspaces, so are linearly independent within $P_{d}$ . But by dimension counting, their total dimension is at least that of $P_{d}$ Hence they exhaust $P_{d}$ , and the zero eigenspace cannot have dimension greater than $\dim(P_d) - \dim(P_{d - 2})$ , as desired.
